import { useGetProgramAccountQuery } from '@/features/caarbonrealestateclient/data-access/use-get-program-account-query'

import { AppAlert } from '@/components/app-alert'
import { useSolana } from '@/components/solana/use-solana'

export function CaarbonrealestateclientUiProgram() {
